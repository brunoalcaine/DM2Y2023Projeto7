...
import com.example.dm2y2023projeto7.novoCarro


class listaCarro : AppCompatActivity() {

    val db = Firebase.firestore

    val listaDados = mutableListOf<newCarro>()
    ...
    private fun ListarCarros(querySnapshot: QuerySnapshot) {
        ...
        for (document in querySnapshot) {
            ...
            if (id != null && nomeCarro != null && valorCarro != null) {
                val carro = newCarro(id, nomeCarro, valorCarro)
